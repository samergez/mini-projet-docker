        ...
        for mid in new_mail_ids:
            ...
            if msg.is_multipart():
                for part in msg.walk():
                    ...
                    # CORRECTION : Si un nom de fichier existe, on enregistre la pièce jointe
                    # sans dépendre de la présence stricte de "attachment" dans Content-Disposition
                    if filename:
